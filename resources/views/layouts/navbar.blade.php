<nav class= "bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700 absolute top-0 left-0 w-full z-50 ">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        
        <!--left section-->
        <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="https://www.svgrepo.com/show/246197/garden-tree.svg" class="h-8" alt="Flowbite Logo" />
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Gardevoir</span>
        </a>
            ...
            <ul
                ...
                <li>
                    ...
                    <div id="dropdownNavbar"
                        class="z-10 hidden opacity-0 scale-95 -translate-x-3 transition-all duration-300 ease-out origin-top-left font-normal bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44 dark:bg-gray-700 dark:divide-gray-600">
                ...
                <li>
                    <a href="/catalog"
                        class="block py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Catalog</a>
                </li>
                <li>
                    <a href="/contact"
