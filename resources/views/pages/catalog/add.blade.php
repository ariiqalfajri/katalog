            ...
            <form action="/catalog" method="POST">
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    <div class="sm:col-span-2">
                        <label for="catalog_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Catalog
                            Name</label>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea id="catalog_description" rows="8" name="catalog_description"
