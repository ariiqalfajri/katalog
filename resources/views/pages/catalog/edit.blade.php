                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="nama_katalog" id="nama_katalog"
                            ...
                            value="{{ old('nama_katalog', $catalog->nama_katalog) }}" required>
                    </div>

                    <div class="sm:col-span-2">
                        <label for="deskripsi_katalog"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Description</label>
                        <textarea id="deskripsi_katalog" name="deskripsi_katalog" rows="8"
                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300"
                            placeholder="Your description here" required>{{ old('deskripsi_katalog', $catalog->deskripsi_katalog) }}</textarea>
                    </div>
